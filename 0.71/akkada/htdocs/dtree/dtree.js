function Node(id, pid, name, url, title, target, isopen, img, status, ip, probe, no_status, no_popup)
{
	this.id = id;
	this.pid = pid;
	this.name = name;
...
function dTree(objName)
{
	...
	this.add = function(id, pid, name, url, title, target, isopen, img, status, ip, probe, no_status, no_popup)
	{
		this.arrNodes[this.arrNodes.length] = new Node(id, pid, name, url, title, target, isopen, img, status, ip, probe, no_status, no_popup);
	}
...
//alert(this.strOutput);
				...
				if (cn.id != '0' && this.hide_status != 'true' && cn.no_status != 1 && cn.status != '') {
