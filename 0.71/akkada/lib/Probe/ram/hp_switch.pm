...
our $OID = '1.3.6.1.4.1.11.2.14.11.5.1.1.2.1.1.1';
...
{   
    ...
    my $total = $ram->{MemTotalBytes};
    my $avail = $ram->{MemFreeBytes};
...
{   
    ...
    my $per;
    my $avail = $data->{MemFreeBytes};
    my $total = $data->{MemTotalBytes};
...
sub prepare_ds_bytes
{
    ...
    {
        push @$args, "DEF:ds0tr=$rrd_file:MemTotalBytes:$cf";
        push @$args, "DEF:ds0a=$rrd_file:MemFreeBytes:$cf";
...
#        push @$args, "STACK:ds0a#00CC33:available";
    ...
    {   
        push @$args, "DEF:ds0tb=$rrd_file:MemTotalBytes:$cf";
        push @$args, "DEF:ds0ab=$rrd_file:MemFreeBytes:$cf";
